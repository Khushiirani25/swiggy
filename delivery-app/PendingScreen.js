  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.desc}>Your profile has been submitted to the QuickBite Citadel. Our admins are currently reviewing your details. Please check back later.</Text>
